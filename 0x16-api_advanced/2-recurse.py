#!/usr/bin/python3
"""query list for Reddit subreddit.
"""
...
def recurse(subreddit, hot_list=[], after="", count=0):
    ...
    """
    # Constructing the URL for the subreddit's hot posts in JSON format
    url = "https://www.reddit.com/r/{}/hot/.json".format(subreddit)

    # Defininf headers for the HTTP request, including User-Agent
    headers = {
    ...
    # Checking if the response status code indicates a not-found error (404)
