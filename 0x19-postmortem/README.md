Postmortem
Upon the release of ALX School's System Engineering & DevOps project 0x19, approximately 00:07am (GMT), an outage occurred on an isolated Ubuntu 14.04 container running an Apache web server. GET requests on the server led to 500 Internal Server Error's, when the expected response was an HTML file defining a simple ALX WordPress site.

Debugging Process
Bug debugger Foster(FS... as in my actual initials... made that up on the spot, pretty good, ) encountered the issue upon opening the project and being, well, instructed to address it, roughly 19:20 GMT. He promptly proceeded to undergo solving the problem.
...
But of course, it will never occur again, because as a programmer i learnt from my mistake.
